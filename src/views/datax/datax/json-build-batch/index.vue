    ...
    <div class="build-container">
      ...
      <div v-show="active===4" class="step4">
        ...
        >
          ...
          <pagination v-show="total>0" :total="total" :pageNo.sync="listQuery.current" :limit.sync="listQuery.size" @pagination="fetchData" />
        </el-drawer>
        <div style="margin-bottom: 20px;" />
      </div>
      <div class="pull-center">
        <el-button :disabled="active===1" style="margin-top: 12px;" @click="last" size="mini">上一步</el-button>
        <el-button v-show="active!==4" type="primary" style="margin-top: 12px;margin-bottom: 12px;" size="mini" @click="next">下一步</el-button>
      </div>
...
.build-container{ 
  padding: 30px;
  .pull-center{ text-align: center;margin-top:30px;}
  }
</style>
