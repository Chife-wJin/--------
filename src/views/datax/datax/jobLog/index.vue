  ...
  <div class="app-container">
    ...
    >
      <el-form-item label="任务id:" prop="jobId">
        <el-input v-model="queryParams.jobId" placeholder="任务id" style="width: 180px;" />
      </el-form-item>
      <el-form-item label="执行器:" prop="jobGroup">
        <el-select v-model="queryParams.jobGroup" placeholder="执行器">
          <el-option v-for="item in executorList" :key="item.id" :label="item.title" :value="item.id" />
        </el-select>
      </el-form-item>
      <el-form-item label="类型:" prop="logStatus">
        <el-select v-model="queryParams.logStatus" placeholder="类型" style="width: 200px">
    ...
    >
      ...
      <el-table-column label="操作" align="center" width="300">
        <template slot-scope="{row}">
          <el-button v-show="row.executorAddress"
              size="mini"
              type="text"
              icon="el-icon-search"
          ...
          <el-button v-show="row.handleCode===0 && row.triggerCode===200"
                     size="mini"
                     type="text"
                     icon="el-icon-plus"
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" width="700px">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="center" label-width="100px" class="dialog-form">
        <el-row>
