<template>
  <div class="app-container">
    <el-form
        ...
        label-width="88px"
    >
      <el-form-item label="执行器:" prop="registryKey">
        <el-input v-model="queryParams.registryKey" placeholder="执行器" style="width: 180px;" class="filter-item" />
      </el-form-item>
      <el-form-item>
        <el-button
            type="primary"
        ...
        >搜索</el-button
        >
        <el-button icon="el-icon-refresh" size="mini"  type="primary" plain @click="resetQuery">
          重置
        </el-button>
      </el-form-item>
    </el-form>
