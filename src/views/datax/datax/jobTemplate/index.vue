  ...
  <div class="app-container">
    ...
    >
      <el-form-item label="任务描述:" prop="jobDesc">
        <el-input v-model="queryParams.jobDesc" placeholder="任务描述" style="width: 200px;" class="filter-item" />
      </el-form-item>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" center width="1200px" :before-close="handleClose">
...
export default {
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        executorBlockStrategy: [{ required: true, message: '请选择路由策略', trigger: 'change' }],
        jobDesc: [{ required: true, message: '请输入任务描述', trigger: 'blur' }],
        jobProject: [{ required: true, message: '请选择所属项目', trigger: 'blur' }],
  ...
  methods: {
    ...
    fetchData() {
      ...
      jobTemp.getList(this.queryParams).then(response => {
        const { content } = response
