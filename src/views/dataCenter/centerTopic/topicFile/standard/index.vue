  ...
  <div class="app-container">
    ...
    <div class="right">
      ...
      <el-table v-loading="loading" border class="container-table" :data="List">
        ...
        <el-table-column prop="area" label="适用区域" width="100"></el-table-column>
        ...
        <el-table-column
          ...
          width="100"
        ></el-table-column>
        <el-table-column prop="isFail_text" label="文件状态" width="100"></el-table-column>
