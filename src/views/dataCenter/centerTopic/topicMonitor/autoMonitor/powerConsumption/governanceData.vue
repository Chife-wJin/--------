...
import {
  ...
  ecmHisdatPollutantTreatmentPage } from "@/api/dataCenter/centerTopic";
...
export default {
  ...
  methods: {
    async getListData() {
      ...
      const reponse = await ecmHisdatPollutantTreatmentPage(this.queryParams);
      // console.log(reponse);
    ...
    selectChanged(value){
      ecmPollutantTreatmentPointList({enterpriseId:value}).then((res) => {
        // console.log(res);
