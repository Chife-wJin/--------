    ...
    >
      ...
      <el-row :gutter="24">
        ...
        <el-col :span="12">
          <el-form-item label="用户名：" prop="loginName">
            <!-- <span slot="label"> <i class="input-required">*</i>用户名： </span> -->
            <el-input
      ...
      <el-row :gutter="24">
        <el-col :span="12">
          <el-form-item prop="newPassword">
            <span slot="label"> <i class="input-required">*</i>密码： </span>
            <el-input
      ...
      <el-row :gutter="24">
        <el-col :span="12">
          <el-form-item label="邮箱：" prop="email">
            <span slot="label"> <i class="input-required">*</i>邮箱： </span>
      ...
      <el-row :gutter="24">
        <el-col :span="12">
          <el-form-item label="手机：" prop="mobile">
            <span slot="label"> <i class="input-required">*</i>手机： </span>
      ...
      <el-row :gutter="24">
        <el-col :span="12">
          <el-form-item label="是否允许登录：" prop="loginFlag">
            <el-select v-model="form.loginFlag" style="width: 100%">
              <el-option
        ...
        <el-col :span="12" style="display: none">
          <el-form-item label="sysType：" prop="sysType">
            <el-input v-model="form.sysType"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="24">
      ...
      <el-row>
        <el-form-item class="tab-list-state">
          <el-button type="primary" @click="submitForm" v-formScroll
            >保存</el-button
          >
  ...
  methods: {
    ...
    getuserSee(id) {
      ...
      userSee(userSeeData).then((reponse) => {
        ...
        this.form.sysType = temp.sysType;
