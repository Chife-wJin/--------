...
import {getProcessVariables, readXml, getFlowViewer, getHighlight, flowXmlAndNode} from "@/api/oa/flowable/definition";
import flow from '@/views/support/oa/task/myProcess/detail/flow'
